class ContactView {
    ...
    createViewDiv() {
            ...
            <div class="card-content">
                <div class="media">
                    <div class="media-left">
                        ...
                        <img src= "${this.contact.url}" alt="Placeholder image">
        ...
        view_div.find('.delete_contact').on('click', async (e) => {
            await $.ajax("http://localhost:3010/contact/"+this.contact.id, {type: "DELETE"});
            this.curDiv.remove();
        });
    ...
    createEditDiv() {
        ...
        edit_div.find("form").on('submit', async (e) => {
            ...
            this.contact.url = edit_div.find(".media-content textarea[name='url']").val();
